...
(function() {
        ...
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                for (h = 0; h <
                    ...
                    e = e[g[h]];
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = N.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Na(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = Ua(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Ab(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            if (j >= E[Va])
                i[Bb](j >= E[Oa] ? 0 : k * T(i[kb]() / k));
            if (j >= E[Oa])
                i[Cb](j >= E[oa] ? 0 : k * T(i[lb]() / k));
            if (j >= E[oa])
            ...
            b = 1;
            h = i[Ya]();
            for (var d = i.getTime(), m = i[Xa](), l = i[Qa](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
                e.push(d), j === E[va] ? d = Za(h + b * k, 0) : j === E[Pa] ? d = Za(h, m + b * k) : !g && (j ===
    ...
    ub = {init: function(a, b, c) {
            ...
            if (b.length)
                for (a = c.length; b.length < a; )
                    d = [].concat(b).splice(b.length - f, f), e && (d[f -
    ...
    ra.prototype = {init: function(a, b) {
        ...
        css: function(a) {
            ...
            $ && b && delete a.width;
            if (Da && !Z)
                b && delete a.width, L(this.element, a);
            else {
                for (c in a)
            ...
            if (this.added) {
                ...
                if (c || d)
                    L(b, {marginLeft: c, marginTop: d}), j && n(j, function(a) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (G !== this.cTT) {
                        if (r(j))
                            a.isSVG ? (B = Da ? "-ms-transform" : db ? "-webkit-transform" : eb ? "MozTransform" : Jb ? "-o-transform" : "", k[B] = k.transform = "rotate(" + j + "deg)") : (p = j * bb, s = Y(p), p = ca(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", s, ", M12=", -p, ", M21=", p, ", M22=", s, ", sizingMethod='auto expand')"].join("") : S), L(b, k);
                        k =
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    b = a.width;
                    c = a.height;
                    if (Da && e && e.fontSize === "11px" && c.toPrecision(3) === "22.7")
                        a.height = c = 14;
                    if (d)
                        a.width =
    ...
    Aa.prototype = {Element: ra, init: function(a, b, c, d) {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                    "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = A(b, "x"), j = a.styles, k = j && j.width && u(j.width), m = j && j.lineHeight, l = f.length; l--; )
                b.removeChild(f[l]);
            ...
            var h = this.label(a, b, c, null, null, null, null, null, "button"), i = 0, j, k, m, l, p, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = y({"stroke-width": 1,
                stroke: "#CCCCCC", fill: {linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]]}, r: 2, padding: 5, style: {color: "black"}}, e);
            m = e.style;
            delete e.style;
            ...
            function j() {
                ...
                if (z) {
                    if (!B)
                        a = t(-G * q), b = h ? -A : 0, s.box = B = d ? p.symbol(d, a, b, s.width, s.height) : p.rect(a, b, s.width, s.height, 0, u[Nb]), B.add(s);
            ...
            function k() {
                ...
                c = h ? 0 : A;
                if (r(La) && (a === "center" || a === "right"))
                    b += {center: 0.5, right: 1}[a] * (La - w.width);
    ...
    if (!Z && !$) {
                    ...
                    for (c in a)
                        if (d = a[c], l = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                                ...
                                f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ca(d) && (d += "px");
                            else if (c === "dashstyle")
        ...
        var na = {Element: F, isIE8: ya.indexOf("MSIE 8.0") > -1, init: function(a, b, c) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, p = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, q = 'angle="' + (90 - I.atan((l - a) / (p - c)) * 180 / Ja) + '"', x();
                        else {
    ...
    Ia.prototype = {addLabel: function() {
            ...
            if (l && w)
                r === "inside" && (w = -w), d.opposite && (w = -w), b = this.getMarkPath(H, P, w, l * C, g, f), p ? p.animate({d: b,
                    opacity: c}) : this.mark = f.path(b).attr({stroke: q, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(H))
                i.xy = P = this.getLabelPosition(H, P, i, g, k, u, a, t), this.isFirst && !o(e.showFirstLabel, 1) || this.isLast && !o(e.showLastLabel, 1) ? v = !1 : !y && g && k.overflow === "justify" && !this.handleOverflow(a, P) && (v = !1), t && a % t && (v = !1), v && !isNaN(P.y) ? (P.opacity = c, i[this.isNew ? "attr" : "animate"](P), this.isNew = !1) : i.attr("y", -9999)
        }, destroy: function() {
            Ga(this, this.axis)
        }};
    ...
    ab.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L",
        ...
        defaultBottomAxisOptions: {labels: {align: "center", x: 0, y: 14}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {align: "center", x: 0, y: -5}, title: {rotation: 0}}, init: function(a, b) {
            ...
            if (h)
                ...
                for (; f-- && g === x; )
                    c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Na(b / c, -1) + e[f]);
                ...
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (j = g.xData, j.length)
                            a.dataMin = K(o(a.dataMin, j[0]), Fa(j)), a.dataMax = q(o(a.dataMax, j[0]), pa(j))
                    } else {
                        ...
                        for (h = 0; h < v; h++) {
                            ...
                            G = B[h];
                            if (k)
                                H = (P = G < t) ? l : m, C = P ? n : p, r(H[w]) ? (H[w] = ia(H[w] + G), G = [G, H[w]]) : H[w] = G, c[C] || (c[C] = {}), c[C][w] || (c[C][w] = new Ib(a, a.options.stackLabels, P, w, s, k)), c[C][w].setTotal(H[w]), c[C][w].touched = f;
                        ...
                        if (!a.usePercentage && u.length)
                            g.dataMin = k = Fa(u), g.dataMax = g = pa(u), a.dataMin = K(o(a.dataMin, k), k), a.dataMax = q(o(a.dataMax, g), g);
                        if (r(t))
                            if (a.dataMin >= t)
            ...
            if (a >= 0.5)
                ...
                for (var f = T(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                    i = e.length;
                    for (h = 0; h < i && !m; h++)
                        j = ka(da(f) * e[h]), j > b && (!d || k <= c) && g.push(k),
                                k > c && (m = !0), k = j
                }
            else if (b = da(b), c = da(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ib(a, null, I.pow(10, T(I.log(a) / I.LN10))), g = Ka(this.getLinearTickPositions(a, b, c), ka), !d)
            ...
            if (this.isLog) {
                ...
                d = d.concat(Ab(yb(c), this.min, this.max, a.startOfWeek)), d[0] < this.min && d.shift();
            else
            ...
            if (this.isXAxis)
                g ? (e = g.minPointOffset, f = g.pointRangePadding) :
                        n(this.series, function(a) {
            ...
            if (!i)
                i = f ? (b.getNonLinearTimeTicks || Ab)(yb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = i;
            if (!h)
                e = i[0], f = i[i.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && i.shift(), d.endOnTick ?
            ...
            if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !==
                    !1) {
            ...
            if (B || f)
                if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
                    ...
                    if (!f || b >= a.min && b <= a.max)
                        j[b] || (j[b] = new Ia(a, b)), w && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
            ...
            for (var b =
                    this.plotLinesAndBands, c = b.length; c--; )
    ...
    qb.prototype = {init: function(a, b) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX ||
                        this.zoomY) && k && !this.selectionMarker)
            ...
            if (b && !b.options.stickyTracking && !this.inClass(a.toElement ||
                    a.relatedTarget, "highcharts-tooltip"))
                b.onMouseOut()
        }, onContainerClick: function(a) {
            var b = this.chart, c = b.hoverPoint, d = b.plotLeft, e = b.plotTop, f = b.inverted, g, h, i, a = this.normalize(a);
            a.cancelBubble = !0;
            if (!b.cancelClick)
                c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, v(c, {pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i)}), D(c.series, "click", v(a, {point: c})), c.firePointEvent("click", a)) : (v(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY -
                        e) && D(b, "click", a))
    ...
    rb.prototype = {init: function(a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.baseline = u(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function() {
        ...
        colorizeItem: function(a, b) {
            ...
            if (m || l) {
                ...
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, j.borderRadius, m || 0).attr({stroke: j.borderColor, "stroke-width": m ||
            ...
            d > c && (d = c);
            if (d > 0)
                b !== x && Ha(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: d === 1 ? h : g}).css({cursor: d === 1 ? "default" : "pointer"}), f.attr({text: d + "/" + this.pageCount}), this.down.attr({x: 18 + this.pager.getBBox().width,
    ...
    sb.prototype = {init: function(a, b) {
        ...
        showLoading: function(a) {
            ...
            if (!c)
                this.loadingDiv = c = U(wa, {className: "highcharts-loading"}, v(d.style, {zIndex: 10, display: S}), this.container), this.loadingSpan = U("span", null, d.labelStyle, c);
            this.loadingSpan.innerHTML = a || b.lang.loading;
            if (!this.loadingShown)
                L(c, {opacity: 0, display: "", left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px"}), vb(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown =
                        !0
        ...
        getChartSize: function() {
            ...
            if (f.display && !l.floating)
                if (B === "right") {
                    if (!r(i))
                        this.marginRight = q(this.marginRight,
                                f.legendWidth - s + p + c)
                } else if (B === "left") {
                    if (!r(h))
            ...
            if (m)
                h ? h.animate(r) : this.plotBGImage =
    ...
    Ma.prototype = {init: function(a, b, c) {
            ...
            if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
                if (this.graphic)
                    e = f && this.graphic.symbolName && l[a].r, this.graphic.attr(y(l[a], e ? {x: b - e, y: c - e, width: 2 * e, height: 2 * e} : {}));
                else {
                    if (a && h)
    ...
    R.prototype = {isCartesian: !0, type: "line", pointClass: Ma, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, colorCounter: 0, init: function(a, b) {
            ...
            this.bindAxes();
            v(this, {name: b.name, state: "", pointAttr: {}, visible: b.visible !==
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                for (i = 0; i < l; i++)
                    if (a[i] !== x && (d = {series: this}, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = n ? this.toYData(d) : d.y, m[i] = d.z, h && d.name))
                        h[i] = d.name;
            ...
            for (l = 0; l < g; l++)
                i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(ha(e[l]))) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k);
            if (b && (g !== (c = b.length) || j))
                for (l = 0; l < c; l++)
                    if (l === h && !j && (l += g), b[l])
                        b[l].destroyElements(), b[l].plotX = x;
            this.data = b;
            this.points = m
        }, translate: function() {
            this.processedXData ||
            ...
            for (k = 0; k < g; k++) {
                ...
                if (b && this.visible && q && q[l])
                    n = q[l], q = n.total, n.cum = n = n.cum - p, p = n + p, i && (n =
            ...
            if (d && this.graph)
                d = ja(this.yAxis.len - this.yAxis.translate(a.threshold ||
            ...
            var a = this.chart, b, c = this.options, d = c.animation &&
                    !!this.animate && a.renderer.isSVG, e = this.visible ? "visible" : "hidden", f = c.zIndex, g = this.hasRendered, h = a.seriesGroup;
    ...
    F = ea(R, {type: "column", tooltipOutsidePlot: !0, requireSorting: !1, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth",
            ...
            c.grouping === !1 ? i = 1 : n(b.series, function(b) {
                ...
                if (b.type === a.type && b.visible && a.options.group === c.group)
                    c.stacking ? (f = b.stackKey, g[f] === x && (g[f] = i++), h = g[f]) : c.grouping !==
        ...
        drawGraph: ta, drawPoints: function() {
            ...
            n(a.points, function(e) {
                ...
                if (f !== x && !isNaN(f) && e.y !== null)
                    d = e.shapeArgs, g ? (Ta(g), g.animate(y(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
                else if (g)
                    e.graphic = g.destroy()
            })
        }, drawTracker: function() {
            ...
            if (h && (d = y(h), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width}), !j))
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                for (H = 2; H--; ) {
                    ...
                    for (C = 0; C < J; C++) {
                        ...
                        if (m > 0) {
                            if (w = L.pop(),
                                    F = w.i, z = w.y, c > z && b[F + 1] !== null || c < z && b[F - 1] !== null)
                                z = c
                        } else
                            z = c;
                ...
                if (pa(D) === 0 || this.verifyDataLabelOverflow(D))
                    this.placeDataLabels(), r && g && n(this.points, function(b) {
                        ...
                        if ((v = b.dataLabel) && v._pos)
                            A = v.connX, z = v.connY, j = k ? ["M", A + (u[6] === "left" ? 5 : -5), z, "C", A, z, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), z, "L", u[2], u[3], "L", u[4], u[5]], i ? (i.animate({d: j}), i.attr("visibility", E)) : b.connector = i = a.chart.renderer.path(j).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: E}).add(a.group);
                        else if (i)
